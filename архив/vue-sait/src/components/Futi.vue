<template>
  ...
  >
    ...
    <img height="100" width="250" src="\public\trace.svg" alt="1C" />
    <div class="flex flex-row space-x-3 pt-5">
      <a href="https://api.whatsapp.com/send?phone=89054012969" target="_blank"
        ><img
          height="50"
          width="50"
          src="\public\whatsapp-whats-app-svgrepo-com.svg"
          alt="whatsapp"
      /></a>

      <a href="https://t.me/JackP1888" target="_blank" rel="noopener noreferrer"
        ><img height="50" width="50" src="\public\telegram-svgrepo-com.svg" alt="Telegram"
      /></a>
      <a href="https://vk.com/prostoghora" target="_blank" rel="noopener noreferrer">
        <img src="\public\vk-1-logo-svgrepo-com.svg" alt="ВКонтакте" height="50" width="50" />
      </a>
    </div>
  </footer>
</template>
